...
class TestConfigValidation:
        ...
        cfg = OmegaConf.create(
            {
                ...
                "model": {"model_id": "test_model", "use_dora": True, "seq_len": 512},
                "dataset": {
                ...
                "logging": {"report_to": "none", "project_name": "test_project"},
            }
        )
    ...
    def test_negative_learning_rate_raises_error(self):
        ...
        cfg = OmegaConf.create(
            {"training": {"lr": -0.001, "batch_size": 4}, "peft": {"r": 16}}
        )
    ...
    def test_zero_batch_size_raises_error(self):
        ...
        cfg = OmegaConf.create(
            {"training": {"lr": 0.001, "batch_size": 0}, "peft": {"r": 16}}
        )
    ...
    def test_zero_lora_rank_raises_error(self):
        ...
        cfg = OmegaConf.create(
            {"training": {"lr": 0.001, "batch_size": 4}, "peft": {"r": 0}}
        )
    ...
    def test_configuration_type_validation(self):
        ...
        cfg = OmegaConf.create(
            {
                "training": {"lr": 2e-5, "batch_size": 1, "epochs": 3},
                "peft": {"r": 16, "lora_alpha": 32, "lora_dropout": 0.05},
            }
        )
